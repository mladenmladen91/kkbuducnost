...
// getting the number of posts
	$queryAll = "SELECT * FROM rezultati a JOIN lige b ON a.liga_id = b.id WHERE b.naziv='{$criteria}'";
...
// limiting number of results per page
	...
	$query = "SELECT a.domacin, a.gost, a.domacin_kosevi, a.gost_kosevi, a.datum, a.vrijeme, b.naziv, a.domacin_logo, a.gost_logo, a.dvorana FROM rezultati a JOIN lige b WHERE a.liga_id= b.id AND b.naziv='{$criteria}' ORDER BY a.datum DESC LIMIT $page_1, $per_page";
 ...
 ?>      
	<div class="col-lg-12 game_container p-0 mb-4">
                    ...
                    <div class="col-lg-12 teams">
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-4 text-center py-4">
                                <span class="team_versus text-center"><?php echo $row['domacin_kosevi'] ?>:<?php echo $row['gost_kosevi'] ?></span>
                            </div>
                            <div class="col-lg-5 col-md-4 col-sm-4 text-center px-2 py-4 team">
                               <div class="row">
      ...
      <?php } ?>
       ...
       <?php }else{ ?>
         <div class="col-lg-12 text-center" style="font-size: 22px; color:gray; margin-top:50px; font-weight:600">NEMA REZULTATA U TOM TAKMIČENJU</div>
      <?php } ?>
      </div>
</div>	
