...
<body>
    ...
    <div class="container">
        <input type="hidden" class="tableName" value="kadeti">
        ...
        <div class="row justify-content-center">    
            <div class="col-sm-8 col-12 add_news_container my-4">
                <div class="col-sm-12 col-12 my-4">
                    <span class="add_news_title">DODAJ IGRAČA (kadeti)</span>
                </div>
                <form  class="add_news_form">
                    <input type="hidden" name="table" value="kadeti">
                    ...
                    <div class="col-sm-12 col-12 form-group my-4">
                        ...
                        <div class="col-sm-12 col-12 pl-0">
                            <input required type="number" name="broj" id="prezime" class="add_news_form_text form-control form-control-lg" max="99" min="1">
                        </div>
                    </div>
