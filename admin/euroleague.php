...
<div class="container  px-3 py-3">
        <div class="row">
            <div class="col-sm-6 col-md-5 col-lg-3">
                <a href="dodajTimEuroleague.php" class="btn dodaj_btn  mb-3">
        ...
        <div class="col-lg-12 p-0 text-center" style="overflow-x: auto;min-height:61.5vh;">
            <table class="tableLiga table-hover my-2">
                                  ...
                                  <tbody>
                                     <?php
                                     $stmtSezone = mysqli_prepare($connection, "SELECT a.id, b.naziv, b.logo, a.broj_utakmica, a.dobijene, a.izgubljene, a.krajnja_razlika, a.bodovi FROM euroleague a JOIN timovi b ON a.klub_id = b.id ORDER BY a.bodovi DESC");
                                     $stmtSezone->execute();
                                   ...
                                   ?>  
                                     <tr class="tableRow">
                                      ...
                                      <td>
                                          <a href="izmijeniTimEuroleague.php?id=<?php echo $id ?>" class="edit_btn">IZMIJENI</a>
                                      </td>     
                                      <td>
