...
<nav class="col-xl-10 col-lg-12 navbar navbar-expand-xl mb-3 nav_admin_container">
        ...
        <ul class="navbar-nav nav_admin_container_links text-center">
           ...
           <li class="nav-item dropdown admin_dropdown">
            ...
            <div class="dropdown-menu nav_admin_dropdown-menu text-center p-0" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item mladje_selekcije" href="selekcije.php">Mlađe selekcije</a>
          ...
          <li class="nav-item">
            <a class="nav-link newsfeed" href="newsfeed.php">NEWSFEED</a>
          </li>
