...
<title>Admin - upravni odbor</title>
...
<div class="container  px-3 py-3">
        <div class="row">
            <div class="col-sm-6 col-md-5 col-lg-3">
                <a href="dodajClanaOdbora.php" class="btn dodaj_btn  mb-3">
        ...
        <div class="col-lg-12 p-0 text-center" style="overflow-x: auto;min-height:61.5vh;">
            <table class="tableLiga table-hover my-2">
                                  ...
                                  <tbody>
                                    <?php
                                     $stmtSezone = mysqli_prepare($connection, "SELECT id, ime, prezime, pozicija, fotografija FROM upravni_odbor");
                                     $stmtSezone->execute();
                                   ...
                                   ?>   
                                     <tr class="tableRow">
                                      ...
                                      <td>
                                          <a href="izmijeniClanaOdbora.php?id=<?php echo $id ?>" class="edit_btn">IZMIJENI</a>
                                      </td>
                                      <td>
                                           <input type="hidden" class="rowId" value="<?php echo $id ?>">
                                          <span class="delete_btn">IZBRIŠI</span>
                                          <input type="hidden" class="tableName" value="upravni_odbor">
                                      </td>
                                      </tr>     
                                   <?php } ?>    
                                  </tbody>     
