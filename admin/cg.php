...
<div class="container  px-3 py-3">
        <div class="row">
            <div class="col-sm-6 col-md-5 col-lg-3">
                <a href="dodajTimCg.php" class="btn dodaj_btn  mb-3">
                                  ...
                                  <tbody>
                                   ...
                                   ?>  
                                     <tr class="tableRow">
                                      ...
                                      <td>
                                          <a href="izmijeniTimCg.php?id=<?php echo $id ?>" class="edit_btn">IZMIJENI</a>
                                      </td>     
                                      <td>
                                          <input type="hidden" class="rowId" value="<?php echo $id ?>">
                                          <span class="delete_btn">IZBRIŠI</span>
                                          <input type="hidden" class="tableName" value="cg">
                                      </td>
                                      </tr>     
                                    <?php } ?>   
                                  </tbody>     
