...
<title>Dodaj člana osoblja</title>
        ...
        <div class="row justify-content-center">    
            <div class="col-sm-8 col-12 add_news_container my-4">
                <div class="col-sm-12 col-12 my-4">
                    <span class="add_news_title">DODAJ ČLANA (med. tim i ekonom)</span>
                </div>
                <form  class="add_news_form">
                    <input type="hidden" name="table" value="osoblje">
                    ...
                    <div class="col-sm-12 col-12 form-group my-4">
                        ...
                        <div class="col-sm-12 col-12 pl-0">
                            <input required type="text" name="pozicija" id="pozicija" class="add_news_form_text form-control form-control-lg" maxlength="40">
                        </div>
                    </div>
